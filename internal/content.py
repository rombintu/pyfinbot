...
futures = [
    ...
    "Функционал: rub|usd - Настройка отчета в разных валютах",
]
...
update_limit_category = "Выбери категорию на которую хочешь поставить лимит"
update_limit_cost = "Укажи сумму которую не хочешь превышать в месяц"
